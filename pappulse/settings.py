...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-)u*j-5^pj@0&kdsb$89uz-cla-8s+#^5&d77x$l@=0yj2@r92p')
...
# Use environment variables for database configuration if available
